#
# bundled via firejail-bundler 0.2.0 (firejail version: 0.9.76)
#
...
# Redirect
#region: @bundler [/etc/firejail/blink-common.profile] BEGIN
...
dbus-system none
#endregion: @bundler [/etc/firejail/blink-common.profile] END

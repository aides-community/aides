...
#
include aides-google-earth-pro.local
include globals.local
#region: @bundler [aides-google-earth-pro.profile] BEGIN
#region: @bundler [/etc/firejail/google-earth-pro.profile] BEGIN
...
# Redirect
#region: @bundler [/etc/firejail/google-earth.profile] BEGIN
...
restrict-namespaces
#endregion: @bundler [/etc/firejail/google-earth.profile] END
#endregion: @bundler [/etc/firejail/google-earth-pro.profile] END
#endregion: @bundler [aides-google-earth-pro.profile] END
